...
This software is NOT pre-approved by any Institutional Review Board (IRB).
Researchers MUST obtain IRB approval from their institution before conducting
human subjects research with this software. You are solely responsible for:
- Obtaining necessary IRB approvals
- Ensuring compliance with ethical guidelines  
- Modifying consent forms to meet institutional requirements
- All aspects of research ethics compliance
...
By using this software, you acknowledge these responsibilities and agree
the author bears no liability for your research compliance.
...
copyright_text_small = visual.TextStim(
    win=win,
    text="© 2026 Ericson P. Kimbel, II | v0.0.495 | Apache 2.0",
